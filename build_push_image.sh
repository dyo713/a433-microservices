...
#mengdefinisikan variabel yang dipakai untuk nama image, versi image, dan nama akun GitHub
image_name="item-app"
image_version="v1"
github_account="dyo713"

#buat image di Docker
...
#ubah nama image agar sesuai dengan format GitHub Container Registry
